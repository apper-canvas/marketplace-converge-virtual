...
const errorMessage = searchParams.get('message') || searchParams.get('error') || 'An unexpected error occurred. Please try again or contact support if the issue persists.'
